      ...
      <div class="container-fluid">
        ...
        <div class="kontenadmin">
          <p>
            ...
            <form method="post" action="page_anggota.php">
              <div class="form-groups">
                <input type="text" name="Search" class="form-control" style="width: 20%; float: left; margin-right: 1%;" placeholder="Nama Anggota...">
          ...
          <table class="table table-striped">
            ...
            <?php 
              ...
              if(isset($_POST['btn_search'])){
                $Search = $_POST['Search'];
                $sql = "SELECT * FROM tbanggota WHERE Nama LIKE '%$Search%'";
              }else{
            ...
            <tr>
              ...
              <td>
                <a href="page_anggota.php?id=<?= $data['IdAnggota']; ?>"><button class="btn btn-success">Update</button></a> || 
                <a href="proses/proses_anggota.php?id=<?= $data['IdAnggota']; ?>" onClick="return valDelete()"><button class="btn btn-danger">Delete</button></a>
              </td>
            </tr>
            <?php } ?>
          </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="proses/proses_anggota.php">
          <div class="form-groups">
            <label>Nama</label>
          ...
          <div class="form-groups">
            ...
            <input type="date" name="TglBergabung" class="form-control" required>
          </div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
          $IdAnggota = $_GET['id'];
          $sql = "SELECT * FROM tbanggota WHERE IdAnggota ='$IdAnggota'";
          $query = $conn->query($sql);

          while ($edata = $query->fetch_array()) {
        ?>
        <form method="post" action="proses/proses_anggota.php">
          <input type="hidden" name="IdAnggota" class="form-control" value="<?= $edata['IdAnggota']; ?>">
          <div class="form-groups">
            <label>Nama</label>
          ...
          <div class="form-groups">
            <label>Alamat</label>
            <textarea name="Alamat" class="form-control" rows="3" required><?= $edata['Alamat']; ?></textarea>
          </div>
          <div class="form-groups">
            <label>Tanggal Bergabung</label>
            <input type="date" name="TglBergabung" class="form-control" value="<?= $edata['TglBergabung']; ?>" required>
          </div>
      </div>
      <div class="modal-footer">
