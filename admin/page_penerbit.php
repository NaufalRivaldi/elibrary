      ...
      <div class="container-fluid">
        ...
        <div class="kontenadmin">
          <p>
            ...
            <form method="post" action="page_penerbit.php">
              <div class="form-groups">
                <input type="text" name="Search" class="form-control" style="width: 20%; float: left; margin-right: 1%;" placeholder="Nama Penerbit...">
          ...
          <table class="table table-striped">
            ...
            <?php 
              ...
              if(isset($_POST['btn_search'])){
                $Search = $_POST['Search'];
                $sql = "SELECT * FROM tbpenerbit WHERE NamaPenerbit LIKE '%$Search%'";
              }else{
            ...
            <tr>
              ...
              <td><?= $data['Alamat']; ?></td>
              <td>
                <a href="page_penerbit.php?id=<?= $data['KdPenerbit']; ?>"><button class="btn btn-success">Update</button></a> || 
                <a href="proses/proses_penerbit.php?id=<?= $data['KdPenerbit']; ?>" onClick="return valDelete()"><button class="btn btn-danger">Delete</button></a>
              </td>
            </tr>
            <?php } ?>
          </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="proses/proses_penerbit.php">
          <div class="form-groups">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php 
          $KdPenerbit = $_GET['id'];
          $sql = "SELECT * FROM tbpenerbit WHERE KdPenerbit ='$KdPenerbit'";
          $query = $conn->query($sql);

          while ($edata = $query->fetch_array()) {
        ?>
        <form method="post" action="proses/proses_penerbit.php">
          <input type="hidden" name="KdPenerbit" class="form-control" value="<?= $edata['KdPenerbit']; ?>">
          <div class="form-groups">
            <label>Nama Penerbit</label>
            <input type="text" name="NamaPenerbit" class="form-control" value="<?= $edata['NamaPenerbit']; ?>" required>
          </div>
          <div class="form-groups">
            <label>Alamat</label>
